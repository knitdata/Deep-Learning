...
**6.2.1 first recurrent layer in Keras**
...
**6.2.3 concrete LSTM example in Keras**
...
**6.3 Advance use of recurrent neural networks**
...
**6.4.4 Combining CNNs and RNNs to process long sequence**
```{r}
