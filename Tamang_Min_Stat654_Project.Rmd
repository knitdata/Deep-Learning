...
Step 2: Find an example picture of the style of painting you want to apply.

Step 3: Start with the R Notebook 8.3-neural-style-transfer.Rmd. Import your own picture and import the style of painting you like. Warning: This .Rmd file no longers works. You can use this alternative eager_styletransfer.R.

Step 4: Compare.
Extra Credit: Research the algorithm used. Who created it? What is the cell phone app Prism? How is the neural network implemented in Keras?
